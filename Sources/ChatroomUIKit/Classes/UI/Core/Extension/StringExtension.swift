...
public extension Chatroom where Base == String {
    var numCount: Int {
        var count = 0
    ...
    func containsEmoij() -> Bool {
        base.chatroom.isRegularCorrect("[^\\u0020-\\u007E\\u00A0-\\u00BE\\u2E80-\\uA4CF\\uF900-\\uFAFF\\uFE30-\\uFE4F\\uFF00-\\uFFEF\\u0080-\\u009F\\u2000-\\u201f\r\n]")
    }
    ...
    func timeStampToString(dateFormat: String?) -> Base {
        var string = base
        if(base.count >= 10){
            string = base.chatroom.subStringTo(10)
        }
    ...
    func convertToTextImage(font: UIFont, textColor: UIColor, size: CGSize) -> UIImage? {
        ...
        let imgWidth = base.chatroom.sizeWithText(font: font, size: size).width
