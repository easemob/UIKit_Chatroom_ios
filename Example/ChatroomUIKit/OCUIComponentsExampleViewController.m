...
- (void)viewDidLoad {
    ...
    ActionSheet *sheet = [[ActionSheet alloc] initWithItems:@[[[ActionSheetItem alloc] initWithTitle:@"Normal" type:ActionSheetItemTypeNormal tag:@""]] title:nil message:@"" action:^(id<ActionSheetItemProtocol> _Nonnull item, id _Nullable object) {
